...
const CreateRoom = () => {
  ...
  return (
    <div className="bg-black min-h-screen w-full flex flex-col text-white font-montserrat overflow-x-hidden">
      <Navbar />
      <div className="flex-1 flex flex-col items-center px-4 py-6 sm:px-6 md:px-8 lg:justify-center">
        <div className="lg:scale-125 lg:my-auto">
