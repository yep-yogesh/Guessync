      ...
      <div className="flex-1 flex flex-col items-center px-4 py-6 sm:px-6 md:px-8 lg:justify-center lg:scale-125">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mb-6 sm:mb-10 justify-center items-center w-full max-w-2xl px-4">
          ...
          {showCreateBtn && (
            <button
              ...
              disabled={isLoading}
              className={`bg-[#FFFB00] text-black font-silkscreen px-6 py-3 rounded-lg text-base md:text-xl drop-shadow-[0_0_7px_#FFFB00] hover:drop-shadow-[0_0_10px_#FFFB00] w-full md:w-[240px] md:h-14 transition ${
        ...
        {isLoading && (
          <div className="fixed inset-0 bg-black/70 flex flex-col justify-center items-center z-50">
            <div className="w-14 h-14 border-4 border-yellow-400 border-t-transparent rounded-full animate-spin mb-4"></div>
            <p className="text-yellow-400 text-lg font-bold">Creating Room...</p>
          </div>
        )}
      </div>
    </div>
