...
const AboutDev = () => {
  ...
  return (
    <div className="h-screen bg-black text-white font-sans relative flex flex-col overflow-y-auto lg:overflow-hidden">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col md:flex-row justify-center items-center gap-1 sm:gap-5 lg:gap-14 px-4 sm:px-8 lg:px-12 py-6">
        {/* Profile Image */}
        <div className="relative flex justify-center items-center">
          <img
            src="/pfp.png"
            alt="Profile"
            className="w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 lg:w-[350px] lg:h-[350px] object-contain rounded-full z-10 shadow-[0_0_20px_rgba(255,255,255,0.15)]"
          />
        </div>

        {/* Info Card */}
        <div className="relative bg-[#0A0A0A] rounded-2xl border-2 sm:border-4 border-[#FFFB00] shadow-lg px-5 sm:px-8 lg:px-10 py-6 sm:py-8 w-full max-w-[550px] flex flex-col justify-between">
