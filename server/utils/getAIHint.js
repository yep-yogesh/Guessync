...
export const getAIHint = async (songName) => {
  try {
    const model = new ChatGoogleGenerativeAI({
      ...
      // Change 'gemini-pro' to a currently supported model:
...
Avoid mentioning the title or giving it away directly. The hint should make it easier to guess but still be a bit challenging.`
    );
